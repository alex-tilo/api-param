	...
	public class testGetAllAccounts {
		...
		String api 			= "getallaccounts";
		String path 		= "getallaccounts";
		...
		private void setup(String config, String environment) throws FileNotFoundException, IOException {
			...
			p.load(new FileInputStream(config));	 
				...
				RestAssured.basePath 	= "ucommqa";
				RestAssured.port 		= Integer.parseInt(port);
		}

		@Test(enabled = true, priority = 1, description = "API Validation getAllAccounts")
		@Description(
						"<b>URI: </b> https://retail-api.azure-api.net/ <br />" + 
						"<b>Port: </b> 443 <br />" +
						"<b>Environment: </b> QA [ucommqa] <br />"
					)
		public void schemaGetProfile() throws Exception {
			...
			response.then()
					...
					.and()
					.header("Request-Context", containsString("appId=cid-v1:5b0358c3-19ee-4651-91cd-feaa0d77921e"))
					.and()

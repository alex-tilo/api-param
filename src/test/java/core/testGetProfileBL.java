...
public class testGetProfileBL {
	...
	@Test(enabled = true, priority = 1, description = "API Validation getProfile - Blacklisted User")
	@Description(
	...
	public void schemaGetProfile() throws Exception {
		...
		response = given()
				...
				.body(u.readJSONFileAsStringEH(api))
		...
		response.then()
				...
				.and()
				.body(matchesJsonSchemaInClasspath(path + "/schema_bl.json"))
				.extract().response();
	    }

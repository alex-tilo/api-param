...
public class testGetProfileEH {
	...
	@Test(enabled = true, priority = 1, description = "API Validation getProfile - Invalid Request")
	@Description(
	...
	public void schemaGetProfile() throws Exception {
		...
		response = given()
				...
				.body(new String(Files.readAllBytes(Paths.get("src/test/resources" + "/" + api + "/" + "payload_eh.json"))))

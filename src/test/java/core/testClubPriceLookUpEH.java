	...
	public class testClubPriceLookUpEH {
		
		String environment 	= null;
		String config 		= "config.properties";
		String api 			= "clubprice";
		String path 		= "clubprice";
		...
		@Test(dataProvider = "scenarios", dataProviderClass = DataFeed.class,enabled = true, priority = 1, description = "API Validation clubPriceLookUp Error Handling")
		@Description(
						"<b>URI: </b> https://retail-api.azure-api.net/ <br />" + 
						"<b>Port: </b> 443 <br />" +
						"<b>Environment: </b> QA [scanandgoQaJS] <br />"
					)
		public void schemaClubPriceEH(String testcase) throws Exception {

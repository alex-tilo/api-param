...
public class testViewCartEH {
	...
	@Test(dataProvider = "scenarios", dataProviderClass = DataFeed.class,enabled = true, priority = 1, description = "API Validation schemaViewCart api")
	@Description("<b>URI: </b> https://retail-api.azure-api.net/ <br />" + "<b>Port: </b> 443 <br />"
			+ "<b>Environment: </b> QA [scanandgoQaJS] <br />")
	public void schemaViewCartEH(String testcase) throws Exception {
...
//					.header("Content-Encoding", "gzip")
					.and().header("Request-Context", containsString("appId=cid-v1:")).and()

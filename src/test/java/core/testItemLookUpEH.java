...
//	import static org.hamcrest.Matchers.*;
	...
	public class testItemLookUpEH {
		
		
		String environment 	= null;
		String config 		= "config.properties";
		String api 			= "itemlookup";
		String path 		= "itemlookupeh";
		...
		@Test(dataProvider = "scenarios", dataProviderClass = DataFeed.class,enabled = true, priority = 1, description = "API Validation itemLookUpEH")
		@Description(
						"<b>URI: </b> https://retail-api.azure-api.net/ <br />" + 
						"<b>Port: </b> 443 <br />" +
						"<b>Environment: </b> QA [scanandgoQaJS] <br />"
					)
		public void schemaItemLookUpEH(String testcase) throws Exception {

...
public class DataFeed {
	...
	public Object[][] getDataFromDataprovider(Method m) {
		...
		else if(m.getName().equalsIgnoreCase("schemaItemLookUpEH"))     {return new Object[][] 	{{"eh_01"},{"eh_02"}};}
		else if(m.getName().equalsIgnoreCase("schemaAddItemToCartEH"))	{return new Object[][] 	{{"eh_01"},{"eh_02"},{"eh_03"},{"eh_04"},{"eh_05"},{"eh_06"}};} 
		else if(m.getName().equalsIgnoreCase("schemaItemLookUpCH")) 	{return new Object[][] 	{{"01"},{"02"},{"03"},{"04"}};} 		
